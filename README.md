* Programa feito com a finalidade de praticar a classe Scanner e o uso de variaveis comuns como >String, int, double, boolean< onde ao inserir um valor no console o sistema irá ler e mostrar na tela:
